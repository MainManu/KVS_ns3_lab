...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("errorModelType",
                 ...
                 errorModelType);
    cmd.AddValue("propagationModelType", "select ns3::FriisPropagationLossModel or ns3::FixedRssLossModel or ns3::ThreeLogDistancePropagationLossModel or ns3::TwoRayGroundPropagationLossModel or ns3::NakagamiPropagationLossModel", errorModelType);
    cmd.Parse(argc, argv);
    ...
    {
        uint32_t payloadSize = 1450; //1487 IPv4 < 1500 MTU //972; // 1000 bytes IPv4
        ...
        //Datarate = 75 Mbps => TODO: packets/s
